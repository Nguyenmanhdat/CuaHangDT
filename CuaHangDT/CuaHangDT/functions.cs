...
namespace CuaHangDT
{
    internal class functions
    {
        ...
        {
            conString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\OneDrive\Máy tính\cơ sở lập trình 2\CuaHangDT\CuaHangDT\CuaHangDT\Database\CuaHangDienThoai.mdf;Integrated Security=True";
            // doi tuong ket noi
