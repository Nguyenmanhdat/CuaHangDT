...
namespace CuaHangDT
{
    public partial class frmNhanvien : Form
    {
        ...
        private void dgvDMNV_Click(object sender, EventArgs e)
        {
            ...
            if (dgvDMNV.CurrentRow.Cells[2].Value.ToString() == "Nam") ckhGioitinh.Checked = true;
            ...
            cboMaque.Text = dgvDMNV.CurrentRow.Cells[6].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
            btnHuy.Enabled = true;
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            loadDataToGridView();
            txtMaNV.Text = functionN.tangkey("select top(1) convert(integer ,substring(MaNV,3,3)+1) as soma from  tblNhanvien order by soma desc", "nv");
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            cboMaque.SelectedValue.ToString() + "',Maque=N'" +
