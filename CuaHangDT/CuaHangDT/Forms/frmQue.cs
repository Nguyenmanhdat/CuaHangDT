...
namespace CuaHangDT
{
    public partial class frmQue : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            loadDataToGridView();
            txtMaque.Text = functionN.tangkey("select top(1) convert(integer ,substring(Maque,3,3)+1) as soma from  tblQue order by soma desc", "q");
        }
...
MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void dgvQue_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void txtMaque_TextChanged(object sender, EventArgs e)
        {
